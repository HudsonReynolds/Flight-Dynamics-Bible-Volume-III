...
A MATLAB Script which shows such \glspl{geodesic} is included in the Appendix in \autoref{script:Geodesic}. The output of the script is shown in \autoref{}

\begin{figure}
    \centering
    \includesvg[width=\columnwidth]{Geodesic.svg}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
