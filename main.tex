...
\newtcblisting{matlabscript}[2]{%
  ...
  overlay={%
    ...
    \end{tcbclipinterior}
    % language badge (uses the separate language argument #1)
    \node[
      anchor=north east,
      rounded corners=2pt,
      ...
      inner ysep=2pt,
      fill=matcolor!30
    ] at ([xshift=-4pt,yshift=-4pt]frame.north east) {#1};
  }
}

\newtcblisting{pythonscript}[2]{%
  listing engine=minted,
  listing only,
  breakable,
  minted language=#1,
...
\begin{dedication}
    This document is dedicated to Purdue Space Program Liquids. PSP Liquids has given me a vast amount of experience and means to explore the realm of Flight Dynamics. I hope that I can contribute to the wealth of information provided by PSP with this document.
\end{dedication}
