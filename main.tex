...
\title{\Huge \textbf{Flight Dynamics Bible}  \\ \huge Volume III: \\Energy Mechanics}
...
As a note, while our work on flight dynamics has mainly focused on modeling rockets, we hope that this document can be used more widely in a variety of applications pertaining to energy mechanics. As such, we have attempted to include content that is useful for other systems, such as orbital dynamics and physics systems, insofar as we have experience in these areas. 
...
In this 3rd volume, I will cover Energy mechanics. This topic is largely a grad-level subject. At Purdue, this is covered in AAE 507 and AAE 508. It is thus a large undertaking to cover the scope of two grad level courses in this text. However, I think that motivated undergrad students can grasp energy methods and may find them more satisfying than the Newtonian mechanics that are presented in typical undergrad classes.

This volume attempts to derive most of these equations in a way that is intuitive for an undergraduate reader. As such, some of the derivations do not include the exacting mathematical precision found in other texts. In these instances, I try to either include footnotes noting what has been glossed over or linking to other texts.

\chapter{Historical Background }

In this chapter we will mostly cover the five main figures who are instrumental to our study of energy mechanics. These five are Isaac Newton, Johann Bernoulli, Leonhard Euler,  Joseph Louis-Lagrange, and William Hamilton.

The story of these figures is greatly intertwined. It is impossible to discuss one figure without discussing the others as well. This section will thus take on a more chronological approach, but background information about many of the important characters is also included here.
...
The book by Goldstine \cite{goldstine_history_1980} has been especially useful in the development of this chapter.
...
Born on Christmas Day in 1643, Newton was born into an England in the midst of a civil war and full of strife. His father had died 3 months prior to his birth, and he was born prematurely. Newton was unwanted by his own mother, so he was raised by his maternal grandmother, Margery Ayscough.
...
\includegraphics[width=\linewidth]{diagram-20250322.png}
