...
\usepackage[paperwidth=7in, paperheight=10in, 
            ...
            bindingoffset=0.25in]{geometry}3141
...
\newcommand{\exampleframeconfig}{%
  \ifodd\value{page}
    \mdfsetup{leftline=false,rightline=true}
  \else
    \mdfsetup{leftline=true,rightline=false}
  \fi
}
...
\date{December 2025 \\ \newline \large{\textbf{First Edition}}}
