...
In fact, we can notice that the potential energy, generally, is a function of the position, $y$, and the kinetic energy is a function of $y'$ -- the time derivative of the position.

As a result, we can write our \gls{Lagrangian} quite generally as:
$$\int_{t_1}^{t_2}f(y,y'$$
