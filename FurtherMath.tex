...
\begin{itemize}
    ...
    \item It satisfies the Jacobi Identity, which states that: $[x,[y,z]]+[y,[z,x]]+[z,[x,y]]=0$.\endnote{Readers of Volume II should find there properties very similar to the properties of the wedge product. The \gls{lie algebra} and the Grassman algebra over which the wedge product is defined are very similar.}
\end{itemize}
