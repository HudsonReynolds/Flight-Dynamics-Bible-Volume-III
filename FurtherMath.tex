...
It is my view that the best understanding of control theory can only be attained with a proper mathematical background.

For this reason, I have developed this section to serve as a foundation for more advanced mathematical concepts which you are unlikely to find in undergraduate studies. Some topics, such as complex numbers and signal analysis -- while incredibly important -- are not given great emphasis here since they are often covered in standard curriculum.

Instead, I have placed an emphasis on the ideas which carry great weight in control theory but are far less discussed. I hope that the intrepid reader will gain great value from the topics discussed in this part.
...
Of course, groups are much more than this. We can think of this example as being analogous to thinking of numbers as physical groups of objects. When you first learn numbers, you might picture `3' as say, `3 things'. But the concept becomes much more powerful when you think of `3' as an abstraction -- representing many possible different things. This abstraction will be even more useful for groups, so try and keep the idea of the group flexible in your mind.

If you want to dive deeper into group theory, a wonderful introductory text which is still mathematically rigorous can be found in \cite{armstrong_groups_1988}.
