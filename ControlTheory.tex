...
I assume that most readers are familiar with the Fourier series and transform, but if not, we should briefly summarize it to gain a better understanding of what we are trying to do. The Fourier series is a way of representing a periodic function in terms of $\sin$ and $\cos$ components. Sometimes, we may see this more compactly expressed as $e^{i\theta}$. Either way, we are trying to express some function in terms of periodic components.
