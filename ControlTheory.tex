...
The physical design of the pendulum is quite important to understand which dynamical phenomena are important for our modeling. A technical drawing of the pendulum is shown in 

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Images/InvertedPendulum.pdf}
    \caption{Caption}
