...
$$u(t)*g(t)=y(t)$$
To figure out what this relationship should be, we should start by considering the simple case of the delta function:

\begin{figure}
    \centering
     \includesvg[width=\linewidth]{Images/DeltaFunction.svg}
