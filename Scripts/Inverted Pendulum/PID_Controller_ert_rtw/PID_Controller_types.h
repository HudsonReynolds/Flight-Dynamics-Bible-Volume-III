...
#ifndef typedef_codertarget_arduinobase_in_kh_T
#define typedef_codertarget_arduinobase_in_kh_T

typedef struct tag_FHZ7JioS7qem7UEAKh2LfE codertarget_arduinobase_in_kh_T;

#endif                             /* typedef_codertarget_arduinobase_in_kh_T */
...
#ifndef typedef_cell_wrap_PID_Controller_T
#define typedef_cell_wrap_PID_Controller_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_PID_Controller_T;
...
struct tag_vTj0iqkGrgefKAHauMLzJD
{
  ...
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_PID_Controller_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
  real_T pCumSumRev;
