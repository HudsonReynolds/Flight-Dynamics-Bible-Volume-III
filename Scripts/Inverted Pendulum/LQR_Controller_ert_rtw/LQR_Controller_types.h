...
typedef struct tag_RWocY1aAVmuibq0rYX5t0G codertarget_arduinobase_int_p_T;
...
#ifndef typedef_codertarget_arduinobase_in_py_T
#define typedef_codertarget_arduinobase_in_py_T

typedef struct tag_FHZ7JioS7qem7UEAKh2LfE codertarget_arduinobase_in_py_T;

#endif                             /* typedef_codertarget_arduinobase_in_py_T */
...
typedef struct P_LQR_Controller_T_ P_LQR_Controller_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_LQR_Controller_T RT_MODEL_LQR_Controller_T;

#endif                                 /* LQR_Controller_types_h_ */
