...
#ifndef motorRPMTest_types_h_
#define motorRPMTest_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_cell_wrap_motorRPMTest_T
#define typedef_cell_wrap_motorRPMTest_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_motorRPMTest_T;

#endif                                 /* typedef_cell_wrap_motorRPMTest_T */
...
struct tag_JWcuUSYp0PvSKTyOAPxz7G
{
  ...
  cell_wrap_motorRPMTest_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
  real_T pCumSumRev[3];
...
typedef struct tag_JWcuUSYp0PvSKTyOAPxz7G dsp_simulink_MovingAverage_mo_T;
...
#ifndef typedef_codertarget_arduinobase_in_mk_T
#define typedef_codertarget_arduinobase_in_mk_T

typedef struct tag_FHZ7JioS7qem7UEAKh2LfE codertarget_arduinobase_in_mk_T;

#endif                             /* typedef_codertarget_arduinobase_in_mk_T */
...
typedef struct P_motorRPMTest_T_ P_motorRPMTest_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_motorRPMTest_T RT_MODEL_motorRPMTest_T;

#endif                                 /* motorRPMTest_types_h_ */
