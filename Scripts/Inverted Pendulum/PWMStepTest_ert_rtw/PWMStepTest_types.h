...
#ifndef PWMStepTest_types_h_
#define PWMStepTest_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
#ifndef typedef_codertarget_arduinobase_in_kj_T
#define typedef_codertarget_arduinobase_in_kj_T

typedef struct tag_FHZ7JioS7qem7UEAKh2LfE codertarget_arduinobase_in_kj_T;

#endif                             /* typedef_codertarget_arduinobase_in_kj_T */
...
#ifndef typedef_cell_wrap_PWMStepTest_T
#define typedef_cell_wrap_PWMStepTest_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_PWMStepTest_T;

#endif                                 /* typedef_cell_wrap_PWMStepTest_T */
...
struct tag_RjXEw04ORPJfj9f3a8ZkO
{
  ...
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_PWMStepTest_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
  real_T pCumSumRev[2];
...
#ifndef typedef_dsp_simulink_MovingAverage_PW_T
#define typedef_dsp_simulink_MovingAverage_PW_T

typedef struct tag_RjXEw04ORPJfj9f3a8ZkO dsp_simulink_MovingAverage_PW_T;

#endif                             /* typedef_dsp_simulink_MovingAverage_PW_T */
...
typedef struct tag_JWcuUSYp0PvSKTyOAPxz7G dsp_simulink_MovingAverage_k_T;

#endif                              /* typedef_dsp_simulink_MovingAverage_k_T */

/* Parameters (default storage) */
typedef struct P_PWMStepTest_T_ P_PWMStepTest_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PWMStepTest_T RT_MODEL_PWMStepTest_T;

#endif                                 /* PWMStepTest_types_h_ */
