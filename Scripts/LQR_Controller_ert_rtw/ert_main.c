...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) (((LQR_Controller_M->Timing.clockTick0
    +LQR_Controller_M->Timing.clockTickH0* 4294967296.0) * 1) + 0)
    ;
     ...
     case 1 :
      currentTime = (extmodeSimulationTime_T)
        (((LQR_Controller_M->Timing.clockTick1+
           LQR_Controller_M->Timing.clockTickH1* 4294967296.0) * 2) + 0)
        ;
...
int main(void)
{
  ...
  errorCode = extmodeInit(LQR_Controller_M->extModeInfo,
    (extmodeSimulationTime_T *)rteiGetPtrTFinalTicks
    (LQR_Controller_M->extModeInfo));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(LQR_Controller_M, true);
    }
  }
  ...
  runModel =
    ...
    !rtmGetStopRequested(LQR_Controller_M);
