...
\begin{exercise}[Circle Group practice]
    ...
    \begin{enumerate}
        \item Prove that the circle group can be represented by the complex numbers of magnitude 1, which we call $U(1)$. We already showed this was a group. In other words, show that $U(1)\cong \mathbb{S}^1$.
...
\chapter{Rotations with Lie Theory}
After laying out some fundamentals of \gls{lie theory}, we can start applying it to actual problems we encounter to see how we can use it in aerospace and physics applications. These applications, especially in physics, are very numerous. In this chapter, we will focus on the applications in relation to 2D and 3D rotations. Lie theory turns out to be especially useful for understanding the nature of 3D rotations.
...
\chapter{Physics Applications of Lie Theory}


The\footnote{This chapter may be skipped without loss of continuity for the rest of the text.} applications of \gls{lie theory} in physics are especially interesting and provide great insight into our current understanding of the world. 
...
Particle physics is one realm in which \gls{lie theory} becomes indispensible. 

Each generator of a gauge group corresponds to a force mediating particle:
Electromagnetic: $U(1)\rightarrow$ photon (one generator)
Weak: $SU(2)\rightarrow$$W^+,W^-,Z$ (three generators)
Strong: $SU(3)\rightarrow$ gluons of different colors (8 generators)
